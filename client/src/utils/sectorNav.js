...
const SHARED_BOTTOM = [
  ...
  { path:'/departments',      icon:'🏛️', key:'nav.departments'      },
  { path:'/leaves',           icon:'🌴', key:'nav.leaves'           },
  { path:'/attendance',       icon:'⏰', key:'nav.attendance'       },
  { path:'/categories',       icon:'🏷️', key:'nav.categories'       },
